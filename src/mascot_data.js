const texts = [
  [
    ...
    'Я знаю, что скрол до добра не доведет ⊜_⊜',
    'В сети уже 15 минут ヽ(。_°)ノ',
    ...
    'Еще чучуть и до Марианской впадины доскролишь',
    ...
    'Ты сам выставил ограничения. Я тут не при чем',
